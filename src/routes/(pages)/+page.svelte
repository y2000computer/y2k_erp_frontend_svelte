					...
					<div class="flex flex-col md:flex-row md:items-center">
						...
						<DropdownMenu.Root>
							<DropdownMenu.Trigger asChild let:builder>
								<div
									class="mt-5 mr-auto md:mr-0 md:ml-auto md:mt-0"
									use:builder.action
									{...builder}
								>
									<Button variant="outline-secondary" class="font-normal">
										Filter by Category
										<Lucide icon="ChevronDown" class="w-4 h-4 ml-2" />
									</Button>
								</div>
							</DropdownMenu.Trigger>
							<DropdownMenu.Content class="h-32 overflow-y-auto w-44">
								<DropdownMenu.Item>PC & Laptop</DropdownMenu.Item>
								<DropdownMenu.Item>Smartphone</DropdownMenu.Item>
								<DropdownMenu.Item>Electronic</DropdownMenu.Item>
								<DropdownMenu.Item>Photography</DropdownMenu.Item>
								<DropdownMenu.Item>Sport</DropdownMenu.Item>
