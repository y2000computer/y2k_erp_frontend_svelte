...
<div>
	<div class="p-5 mt-8 intro-y xl:w-3/5 box">
		...
		<div class="mt-3 text-xs intro-y text-slate-600 dark:text-slate-500 sm:text-sm">
		...
		>
			...
			<div class="flex items-center mt-5 text-slate-600 dark:text-slate-500 sm:ml-auto sm:mt-0">
				Share this post:
				<Tippy
					as="a"
					href="#top"
		...
		<!-- END: Blog Layout -->
		<!-- BEGIN: Comments -->
		<div class="pt-5 mt-5 border-t intro-y border-slate-200/60 dark:border-darkmode-400">
