<script lang="ts">
	...
	import { Draggable as FullCalendarDraggable } from '$lib/components/Calendar';
		...
		<div class="col-span-12 xl:col-span-4 2xl:col-span-3">
			<div class="p-5 box intro-y">
				<Button variant="primary" type="button" class="w-full mt-2">
					<Lucide icon="Pencil" class="w-4 h-4 mr-2" /> Add New Schedule
				</Button>
				...
				>
					<div class="relative">
						...
						<a class="absolute top-0 bottom-0 right-0 flex items-center my-auto" href="#top">
							<Lucide icon="Pencil" class="w-4 h-4 text-slate-500" />
						</a>
					</div>
					<div class="relative">
						<div
				...
				<FormSwitch class="flex">
					<FormSwitch.Label htmlFor="checkbox-events">Remove after drop</FormSwitch.Label>
					<FormSwitch.Input class="ml-auto" type="checkbox" id="checkbox-events" />
				</FormSwitch>
			</div>
