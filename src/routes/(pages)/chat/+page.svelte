<script lang="ts">
	...
	import { FormInput, FormTextarea } from '$lib/components/Form';
...
<div>
			...
			<DropdownMenu.Root>
				<DropdownMenu.Trigger asChild let:builder>
					<div class="ml-auto sm:ml-0" use:builder.action {...builder}>
						<Button class="px-2 !box text-slate-500">
	...
	<div class="grid grid-cols-12 gap-5 mt-5 intro-y">
		...
		<Tabs.Root value="chats" class="col-span-12 lg:col-span-4 2xl:col-span-3">
			<div class="pr-1 intro-y">
				<div class="p-2 box">
					<Tabs.List variant="pills">
						<Tabs.Trigger value="chats" class="w-full py-2">Chats</Tabs.Trigger>
						<Tabs.Trigger value="friends" class="w-full py-2">Friends</Tabs.Trigger>
						<Tabs.Trigger value="profile" class="w-full py-2">Profile</Tabs.Trigger>
					</Tabs.List>
				</div>
			</div>
							...
							<div class="flex mt-5">
								{#each _.take(fakerData, 10) as faker, fakerKey}
									<a href="#top" class="w-10 mr-4 cursor-pointer">
										...
										<div class="mt-2 text-xs text-center truncate text-slate-500">
											{faker.users[0].name}
										</div>
									</a>
								{/each}
			...
			<Tabs.Content value="friends">
				<div class="pr-1">
					<div class="p-5 mt-5 box">
						...
						<Button variant="primary" type="button" class="w-full mt-3">Invite Friends</Button>
					</div>
				</div>
				<div class="pt-1 pr-1 overflow-y-auto h-[525px] scrollbar-hidden">
					...
					<div class="relative flex items-center p-5 mt-5 cursor-pointer box">
						...
						<DropdownMenu.Root>
							<DropdownMenu.Trigger asChild let:builder>
								<a class="block w-5 h-5 ml-auto" href="/" use:builder.action {...builder}>
									<Lucide icon="EllipsisVertical" class="w-5 h-5 text-slate-500" />
								</a>
							</DropdownMenu.Trigger>
							<DropdownMenu.Content class="w-40">
								<DropdownMenu.Item>
			...
			<Tabs.Content value="profile">
				<div class="pr-1">
					<div class="px-5 py-10 mt-5 box">
						<div class="flex-none w-20 h-20 mx-auto overflow-hidden rounded-full image-fit">
							<img alt="Midone Tailwind HTML Admin Template" src={fakerData[0].photos[0]} />
						</div>
						<div class="mt-3 text-center">
							<div class="text-lg font-medium">
								{fakerData[0]['users'][0]['name']}
							</div>
							<div class="mt-1 text-slate-500">Tailwind HTML Admin Template</div>
						</div>
					</div>
					<div class="p-5 mt-5 box">
						<div
				...
				{#if chatBox}
					<div class="flex flex-col h-full">
							...
							>
								...
								<DropdownMenu.Root>
									<DropdownMenu.Trigger asChild let:builder>
										<a
											href="#top"
											class="w-5 h-5 ml-auto sm:ml-3 text-slate-500"
											use:builder.action
											{...builder}
										>
											<Lucide icon="EllipsisVertical" class="w-5 h-5" />
										</a>
									</DropdownMenu.Trigger>
									<DropdownMenu.Content class="w-40">
										<DropdownMenu.Item>
						...
						<div class="flex-1 px-5 pt-5 overflow-y-scroll scrollbar-hidden">
							<div class="flex items-end float-left mb-4 max-w-[90%] sm:max-w-[49%]">
								...
								<DropdownMenu.Root>
									<DropdownMenu.Trigger asChild let:builder>
										<a
											href="#top"
											class="hidden w-4 h-4 my-auto ml-3 text-slate-500 sm:block"
											use:builder.action
											{...builder}
										>
											<Lucide icon="EllipsisVertical" class="w-4 h-4" />
										</a>
									</DropdownMenu.Trigger>
									<DropdownMenu.Content class="w-40">
										<DropdownMenu.Item>
							...
							<div class="flex items-end float-right mb-4 max-w-[90%] sm:max-w-[49%]">
								<DropdownMenu.Root>
									<DropdownMenu.Trigger asChild let:builder>
										<a
											href="#top"
											class="hidden w-4 h-4 my-auto mr-3 sm:block text-slate-500"
											use:builder.action
											{...builder}
										>
											<Lucide icon="EllipsisVertical" class="w-4 h-4" />
								...
								<div class="relative flex-none hidden w-10 h-10 ml-5 sm:block image-fit">
									<img
										alt="Midone Tailwind HTML Admin Template"
										class="rounded-full"
										src={fakerData[1].photos[0]}
							...
							<div class="clear-both" />
							<div class="mt-5 mb-10 text-xs text-center text-slate-400 dark:text-slate-500">
								12 June 2020
							</div>
							<div class="flex items-end float-left mb-4 max-w-[90%] sm:max-w-[49%]">
								<div class="relative flex-none hidden w-10 h-10 mr-5 sm:block image-fit">
								...
								<DropdownMenu.Root>
									<DropdownMenu.Trigger asChild let:builder>
										<a
											href="#top"
											class="hidden w-4 h-4 my-auto ml-3 sm:block text-slate-500"
											use:builder.action
											{...builder}
										>
											<Lucide icon="EllipsisVertical" class="w-4 h-4" />
						...
						>
							...
							/>
							<div class="absolute bottom-0 left-0 flex mb-5 ml-5 sm:static sm:ml-0 sm:mb-0">
								<DropdownMenu.Root>
									<DropdownMenu.Trigger asChild let:builder>
										<a
											href="#top"
											class="block w-4 h-4 mr-3 sm:mr-5 sm:w-5 sm:h-5 text-slate-500"
											use:builder.action
											{...builder}
										>
									...
									<DropdownMenu.Content class="px-2 pt-2 pb-3 w-[320px]">
										<Tabs.Root value="2" class="flex flex-col h-[364px]">
											<div class="px-1 pt-1">
												<div class="relative text-slate-500">
													<FormInput
														type="text"
											...
											<Tabs.List variant="pills" class="px-1 mt-5">
												<Tabs.Trigger
													value="1"
													class={clsx([
														'w-full px-0 py-2 border-0 hover:bg-slate-100 dark:hover:bg-darkmode-400',
														'data-[state=active]:bg-slate-200 data-[state=active]:hover:bg-slate-200 data-[state=active]:border-b-0 data-[state=active]:text-slate-600 data-[state=active]:dark:bg-darkmode-300 data-[state=active]:dark:text-slate-300'
													])}
												>
													<svg
											...
											<div class="mt-5 overflow-hidden">
												<Tabs.Content value="1">
													...
													<div class="h-full pb-10 mt-2 overflow-y-auto scrollbar-hidden">
				...
				{#if !chatBox}
					<div class="flex items-center h-full">
						<div class="mx-auto text-center">
							<div class="flex-none w-16 h-16 mx-auto overflow-hidden rounded-full image-fit">
								<img alt="Midone Tailwind HTML Admin Template" src={fakerData[0].photos[0]} />
							</div>
							<div class="mt-3">
								...
								<div class="mt-1 text-slate-500">Please select a chat to start messaging.</div>
							</div>
						</div>
					</div>
				{/if}
