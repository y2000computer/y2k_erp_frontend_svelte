<script lang="ts">
	...
	import TinySlider, { type TinySliderElement } from '$lib/components/TinySlider';
		...
		<div class="grid grid-cols-12 gap-6">
			...
			<div class="col-span-12 mt-2 sm:col-span-6 lg:col-span-4 xl:col-span-3">
				...
				>
					<div class="p-5 box">
						<div class="flex items-center">
							...
							<DropdownMenu.Root>
								<DropdownMenu.Trigger asChild let:builder>
									<a class="w-5 h-5 ml-auto -mr-2" href="/" use:builder.action {...builder}>
										<Lucide icon="EllipsisVertical" class="block w-5 h-5 text-slate-500" />
									</a>
						...
						<Button variant="outline-secondary" class="w-full px-2 py-1 mt-4 border-dashed">
							Real-Time Report
						</Button>
					</div>
				</div>
			...
			<div class="col-span-12 mt-2 sm:col-span-6 lg:col-span-4 xl:col-span-3 lg:mt-6 xl:mt-2">
				...
				<div
					class="mt-5 intro-y relative before:content-[''] before:w-[90%] before:shadow-[0px_3px_5px_#0000000b] before:bg-white/60 before:h-full before:mt-2.5 before:absolute before:rounded-md before:mx-auto before:inset-x-0 before:dark:bg-darkmode-400/70"
				>
					<Tabs.Root value="active" class="p-5 box">
						<Tabs.List
							variant="pills"
			...
			<div class="col-span-12 mt-6 lg:col-span-6">
				<div class="relative p-8 overflow-hidden box bg-primary intro-y">
					...
					<div class="w-full mt-3 leading-relaxed sm:w-72 text-white/70 dark:text-slate-500">
						Apply now, quick registration.
					</div>
					<Button class="w-32 mt-6 bg-white dark:bg-darkmode-800 dark:text-white sm:mt-10">
						Start Now
					</Button>
					<img
			...
			<div class="col-span-12 mt-6 lg:col-span-6">
				<div class="relative p-8 overflow-hidden box intro-y">
					...
					<Tippy as="div" class="relative w-48 mt-6 cursor-pointer" content="Copy referral link">
						<FormInput type="text" value="https://dashboard.in" on:change={() => {}} />
						<Lucide icon="Copy" class="absolute top-0 bottom-0 right-0 w-4 h-4 my-auto mr-4" />
					</Tippy>
					<img
			...
			<div class="grid grid-cols-12 2xl:pl-6 gap-x-6 2xl:gap-x-0 gap-y-6">
							...
							<TinySlider bind:ref={importantNotesRef}>
								<div class="p-5">
									...
									<div class="flex mt-5 font-medium">
										<Button variant="secondary" type="button" class="px-2 py-1">View Notes</Button>
				...
				>
					<div class="flex items-center h-10 intro-x">
						...
						<a href="#top" class="flex items-center ml-auto truncate text-primary">
