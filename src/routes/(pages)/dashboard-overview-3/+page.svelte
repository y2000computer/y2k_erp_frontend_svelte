	...
	<div class="grid grid-cols-12 gap-6">
		<div class="z-20 col-span-12 xl:col-span-9 2xl:col-span-9">
			...
			<div class="grid grid-cols-12 mb-3 mt-14 sm:gap-10 intro-y">
				...
				>
					<DropdownMenu.Root>
						<DropdownMenu.Trigger asChild let:builder>
							<a
								class="absolute pt-0.5 2xl:pt-0 mt-5 2xl:mt-6 top-0 right-0 block"
								href="/"
								use:builder.action
								{...builder}
							>
					...
					<div class="-mb-1 text-sm font-medium 2xl:text-base">
						Hi Angelina,
						<span class="font-normal text-slate-600 dark:text-slate-300"> welcome back! </span>
					</div>
					<div
					...
					>
						...
						<Tippy as="div" content="Total value of your sales: $158.409.416">
							<Lucide icon="CircleAlert" class="w-5 h-5 ml-1.5 mt-0.5" />
						</Tippy>
					</div>
					<div class="mt-5 mb-3 2xl:flex">
						<div class="flex items-center justify-center sm:justify-start">
							<div class="relative pl-3 text-2xl font-medium leading-6 2xl:text-3xl 2xl:pl-4">
								<span class="absolute top-0 left-0 -mt-1 text-xl 2xl:text-2xl 2xl:mt-0"> $ </span>
								142,402,210
							</div>
					...
					<div class="mt-14 2xl:mt-24 w-44 2xl:w-52">
						<DropdownMenu.Root>
							<DropdownMenu.Trigger asChild let:builder>
								<div use:builder.action {...builder}>
									<Button variant="primary" rounded class="relative justify-start w-full px-4">
										Download Reports
										<span
							...
							<DropdownMenu.Content class="w-44 2xl:w-52">
								<DropdownMenu.Item>
									<Lucide icon="FileText" class="w-4 h-4 mr-2" />
									Monthly Report
								</DropdownMenu.Item>
				...
				>
					...
					>
						<Tabs.Trigger value="active" class="w-full py-1.5 px-2">Active</Tabs.Trigger>
						<Tabs.Trigger value="inactive" class="w-full py-1.5 px-2">Inactive</Tabs.Trigger>
					</Tabs.List>
					<div class="mt-6">
		...
		>
			<div class="relative grid grid-cols-12 gap-6 intro-y">
				...
				<div class="col-span-12 px-0 sm:col-span-4 xl:col-span-3 lg:px-6 xl:px-0 2xl:px-6">
					<div class="flex flex-wrap items-center gap-3 lg:flex-nowrap">
						<div class="mr-auto text-lg font-medium truncate sm:w-full lg:w-auto">Social Media</div>
				...
				<div class="col-span-12 px-0 sm:col-span-4 xl:col-span-3 lg:px-6 xl:px-0 2xl:px-6">
					<div class="flex flex-wrap items-center gap-3 lg:flex-nowrap">
						<div class="mr-auto text-lg font-medium truncate sm:w-full lg:w-auto">Posted Ads</div>
						<div
							class="py-1 px-2.5 rounded-full text-xs bg-slate-300/50 dark:bg-darkmode-400 text-slate-600 dark:text-slate-300 cursor-pointer truncate"
						>
							320 Followers
		...
		<div class="z-30 col-span-12 xl:col-span-3 xl:col-start-10 xl:pb-16">
			<div class="flex flex-col h-full">
					...
					<div class="flex flex-wrap gap-3">
						<div class="mr-auto">
							...
							>
								AVAILABLE FUNDS
								<Tippy as="div" content="Total value of your sales: $158.409.416">
									<Lucide icon="CircleAlert" class="w-4 h-4 ml-1.5" />
								</Tippy>
							</div>
				...
				<div class="xl:min-h-0 intro-x">
					<Tabs.Root value="weekly" class="max-h-full mt-5 xl:overflow-y-auto box">
						<div class="top-0 px-5 pt-5 pb-6 xl:sticky">
							...
							>
								<Tabs.Trigger value="weekly" class="w-full py-1.5 px-2">Weekly</Tabs.Trigger>
								<Tabs.Trigger value="monthly" class="w-full py-1.5 px-2">Monthly</Tabs.Trigger>
							</Tabs.List>
						</div>
						<div class="px-5 pb-5">
							<Tabs.Content value="weekly" class="grid grid-cols-12 gap-y-6">
