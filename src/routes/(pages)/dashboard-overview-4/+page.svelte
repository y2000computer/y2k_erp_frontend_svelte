					...
					>
						<div class="grid grid-cols-12 box">
							<div class="flex flex-col justify-center col-span-12 px-8 py-12 lg:col-span-4">
								<Lucide icon="ChartPie" class="w-10 h-10 text-pending" />
								<div
								...
								<div class="flex items-center justify-start mt-4">
									<div class="relative text-2xl font-medium pl-3 ml-0.5">
										<span class="absolute text-xl font-medium top-0 left-0 -ml-0.5"> $ </span>
										1,413,102.02
									</div>
							...
							>
								<Tabs.Root value="weekly">
									...
									<div class="px-5 pb-5">
										<Tabs.Content value="weekly" class="grid grid-cols-12 gap-y-8 gap-x-10">
