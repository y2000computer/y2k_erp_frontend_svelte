<script lang="ts">
	...
	import { FormInput, FormLabel, FormSelect, FormTextarea } from '$lib/components/Form';
...
<div>
			...
			<DropdownMenu.Root>
				<DropdownMenu.Trigger asChild let:builder>
					<div use:builder.action {...builder}>
						<Button class="px-2 !box ml-auto sm:ml-0">
	...
	<div class="grid grid-cols-12 gap-5 mt-5 intro-y">
		...
		<!-- END: Item List -->
		<!-- BEGIN: Ticket -->
		<Tabs.Root value="ticket" class="col-span-12 lg:col-span-4">
			<div class="pr-1 intro-y">
				<div class="p-2 box">
					<Tabs.List variant="pills">
						<Tabs.Trigger value="ticket" class="w-full py-2">Ticket</Tabs.Trigger>
						<Tabs.Trigger value="details" class="w-full py-2">Details</Tabs.Trigger>
					</Tabs.List>
				</div>
			</div>
			<Tabs.Content value="ticket">
				<div class="p-2 mt-5 box">
					{#each _.take(fakerData, 5) as faker, fakerKey}
						...
						>
							...
							<Lucide icon="FilePenLine" class="w-4 h-4 ml-2 text-slate-500" />
				...
				<div class="flex mt-5">
					<Button class="w-32 border-slate-300 dark:border-darkmode-400 text-slate-500">
						Clear Items
					</Button>
					<Button variant="primary" class="w-32 ml-auto shadow-md">Charge</Button>
				</div>
			</Tabs.Content>
	...
	<Dialog.Root bind:open={newOrderModal}>
		<Dialog.Content class="sm:max-w-[425px]">
			...
			<div class="grid grid-cols-12 gap-4 gap-y-3">
				<div class="col-span-12">
					...
					<FormInput id="pos-form-1" type="text" class="flex-1" placeholder="Customer name" />
				</div>
				<div class="col-span-12">
					<FormLabel htmlFor="pos-form-2">Table</FormLabel>
					<FormInput id="pos-form-2" type="text" class="flex-1" placeholder="Customer table" />
				</div>
				<div class="col-span-12">
					<FormLabel htmlFor="pos-form-3">Number of People</FormLabel>
					<FormInput id="pos-form-3" type="text" class="flex-1" placeholder="People" />
				</div>
			</div>
			<Dialog.Footer class="text-right">
				...
				<Button variant="primary" type="button" class="w-32">Create Ticket</Button>
			</Dialog.Footer>
		</Dialog.Content>
	</Dialog.Root>
	<!-- END: New Order Modal -->
	<!-- BEGIN: Add Item Modal -->
	<Dialog.Root bind:open={addItemModal}>
		<Dialog.Content class="sm:max-w-[425px]">
			<Dialog.Header>
			...
			<div class="grid grid-cols-12 gap-4 gap-y-3">
				<div class="col-span-12">
					<FormLabel htmlFor="pos-form-4" class="form-label">Quantity</FormLabel>
			...
			<Dialog.Footer class="text-right">
				...
				<Button variant="primary" type="button" class="w-24">Add Item</Button>
			</Dialog.Footer>
		</Dialog.Content>
	</Dialog.Root>
	<!-- END: Add Item Modal -->
