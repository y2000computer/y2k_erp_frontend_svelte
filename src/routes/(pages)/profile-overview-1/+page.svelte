...
<div>
	...
	<Tabs.Root value="1">
		...
		<div class="px-5 pt-5 mt-5 intro-y box">
			...
			>
				<Tabs.Trigger value="1" class="py-4 cursor-pointer">Dashboard</Tabs.Trigger>
				<Tabs.Trigger value="2" class="py-4 cursor-pointer">Account & Profile</Tabs.Trigger>
				<Tabs.Trigger value="3" class="py-4 cursor-pointer">Activities</Tabs.Trigger>
				<Tabs.Trigger value="4" class="py-4 cursor-pointer">Tasks</Tabs.Trigger>
			</Tabs.List>
		</div>
		<!-- END: Profile Info -->
		<div class="mt-5 intro-y">
			<Tabs.Content value="1">
				<div class="grid grid-cols-12 gap-6">
					...
					<div class="col-span-12 intro-y box lg:col-span-6">
						...
						<div class="p-5">
							...
							<div class="flex flex-col mt-5 sm:flex-row">
								<div class="mr-auto">
									<a href="#top" class="font-medium"> Bootstrap HTML Template </a>
									<div class="mt-1 text-slate-500">HTML, PHP, Mysql</div>
								</div>
								<div class="flex">
									<div class="w-32 mt-5 mr-auto -ml-2 sm:ml-0 sm:mr-5">
					...
					<Tabs.Root value="new" class="col-span-12 intro-y box lg:col-span-6">
						<div
						...
						>
							...
							<Tabs.List variant="link-tabs" class="hidden w-auto ml-auto sm:flex">
								<Tabs.Trigger value="new" class="py-5 cursor-pointer">New</Tabs.Trigger>
								<Tabs.Trigger value="last-week" class="py-5 cursor-pointer">Last Week</Tabs.Trigger>
							</Tabs.List>
						</div>
						<div class="p-5">
							<Tabs.Content value="new">
								...
								<Button as="a" variant="secondary" href="#top" class="block w-40 mx-auto mt-5">
									View More Details
								</Button>
							</Tabs.Content>
						</div>
					...
					<div class="col-span-12 intro-y box lg:col-span-6">
						...
						>
							...
							<DropdownMenu.Root>
								<DropdownMenu.Trigger asChild let:builder>
									<a
										class="block w-5 h-5 ml-auto sm:hidden"
										href="/"
										use:builder.action
										{...builder}
									>
						...
						<div class="p-5">
							<div class="relative flex items-center">
								...
								<div class="ml-4 mr-auto">
									...
									<div class="mr-5 text-slate-500 sm:mr-5">Bootstrap 4 HTML Admin Template</div>
								</div>
							...
							<div class="relative flex items-center mt-5">
								...
								<div class="ml-4 mr-auto">
									...
									<div class="mr-5 text-slate-500 sm:mr-5">Tailwind HTML Admin Template</div>
								</div>
							...
							<div class="relative flex items-center mt-5">
								...
								<div class="ml-4 mr-auto">
									...
									<div class="mr-5 text-slate-500 sm:mr-5">Vuejs HTML Admin Template</div>
								</div>
						...
						<div class="grid grid-cols-1 gap-6 p-5 2xl:grid-cols-7">
							<div class="2xl:col-span-2">
								<div class="grid grid-cols-2 gap-6">
									<div class="col-span-2 p-5 sm:col-span-1 2xl:col-span-2 box dark:bg-darkmode-500">
