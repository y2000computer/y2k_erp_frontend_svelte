		...
		<div class="flex flex-wrap items-center col-span-12 mt-2 intro-y xl:flex-nowrap">
			<div class="flex w-full sm:w-auto">
				<div class="relative w-48 text-slate-500">
					<FormInput type="text" class="w-48 pr-10 !box" placeholder="Search by name..." />
			...
			<div class="flex flex-wrap items-center w-full mt-3 xl:w-auto xl:flex-nowrap gap-y-3 xl:mt-0">
			...
			<Table class="border-spacing-y-[10px] border-separate -mt-2">
				<Table.Thead>
					<Table.Tr>
						...
						<Table.Th class="text-center border-b-0 whitespace-nowrap">POSTED TIME</Table.Th>
				...
				<Table.Tbody>
					{#each _.take(fakerData, 9) as faker, fakerKey}
						<Table.Tr key={fakerKey} class="intro-x">
							...
							>
								<a class="flex items-center underline decoration-dotted" href="#top">
									{faker.users[0].name}
								</a>
							</Table.Td>
							<Table.Td
							...
							>
								<div class="flex items-center">
									<div class="flex items-center">
										<Lucide icon="Star" class="w-4 h-4 mr-1 text-pending fill-pending/30" />
										<Lucide icon="Star" class="w-4 h-4 mr-1 text-pending fill-pending/30" />
										<Lucide icon="Star" class="w-4 h-4 mr-1 text-pending fill-pending/30" />
										<Lucide icon="Star" class="w-4 h-4 mr-1 text-pending fill-pending/30" />
										<Lucide icon="Star" class="w-4 h-4 mr-1 text-slate-400 fill-slate/30" />
									</div>
							...
							>
								<div class="flex items-center justify-center">
									<a class="flex items-center text-primary whitespace-nowrap" href="#top">
