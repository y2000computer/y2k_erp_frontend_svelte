			...
			<Table class="border-spacing-y-[10px] border-separate -mt-2">
				<Table.Thead>
					<Table.Tr>
						...
						<Table.Th class="text-center border-b-0 whitespace-nowrap">STORE</Table.Th>
						<Table.Th class="text-center border-b-0 whitespace-nowrap">GENDER</Table.Th>
						<Table.Th class="text-center border-b-0 whitespace-nowrap">STATUS</Table.Th>
						<Table.Th class="text-center border-b-0 whitespace-nowrap">TOTAL PRODUCTS</Table.Th>
				...
				<Table.Tbody>
					{#each _.take(fakerData, 9) as faker, fakerKey}
						<Table.Tr key={fakerKey} class="intro-x">
							...
							>
								<a class="flex items-center justify-center underline decoration-dotted" href="#top">
