<script lang="ts">
	...
	import TippyContent from '$lib/components/TippyContent';
				...
				<div class="p-5">
					<Preview.Panel>
						<div class="text-center">
							<Tippy as={Button} variant="primary" content="This is awesome tooltip example!">
								Show Tooltip
							</Tippy>
						</div>
					</Preview.Panel>
			...
			<Preview let:toggle class="intro-y box">
				...
				<div class="p-5">
					<Preview.Panel>
						...
						<div class="text-center">
							<Button variant="primary" data-tooltip="custom-tooltip-content">Show Tooltip</Button>
						</div>
			...
			<Preview let:toggle class="mt-5 intro-y box">
				...
				<div class="p-5">
					<Preview.Panel>
						<!-- BEGIN: Custom Tooltip Toggle -->
						<div class="text-center">
							<Button variant="primary" data-tooltip="chart-tooltip">Show Tooltip</Button>
						</div>
						<!-- END: Custom Tooltip Toggle -->
						<!-- BEGIN: Custom Tooltip Content -->
						<div class="tooltip-content">
