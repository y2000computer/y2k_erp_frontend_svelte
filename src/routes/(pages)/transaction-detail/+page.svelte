		...
		<div class="col-span-12 lg:col-span-4 2xl:col-span-3">
			<div class="p-5 rounded-md box">
				...
				>
					...
					<a href="#top" class="flex items-center ml-auto text-primary">
						<Lucide icon="Pencil" class="w-4 h-4 mr-2" /> Change Status
					</a>
				</div>
				<div class="flex items-center">
					<Lucide icon="Clipboard" class="w-4 h-4 mr-2 text-slate-500" />
					Invoice:
					<a href="#top" class="ml-1 underline decoration-dotted"> INV/20220217/MPL/2053411933 </a>
				</div>
				...
				<div class="flex items-center mt-3">
					...
					Transaction Status:
					<span class="px-2 ml-1 rounded bg-success/20 text-success"> Completed </span>
				</div>
			</div>
			<div class="p-5 mt-5 rounded-md box">
				...
				>
					...
					<a href="#top" class="flex items-center ml-auto text-primary">
						<Lucide icon="Pencil" class="w-4 h-4 mr-2" /> View Details
					</a>
				</div>
				<div class="flex items-center">
					<Lucide icon="Clipboard" class="w-4 h-4 mr-2 text-slate-500" />
					...
					<Table striped>
						<Table.Thead>
							<Table.Tr>
								...
								<Table.Th class="text-right whitespace-nowrap">Unit Price</Table.Th>
