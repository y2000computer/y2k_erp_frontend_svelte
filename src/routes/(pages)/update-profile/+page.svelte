		...
		<div class="flex flex-col-reverse col-span-12 lg:col-span-4 2xl:col-span-3 lg:block">
			<div class="mt-5 intro-y box">
				<div class="relative flex items-center p-5">
					...
					<DropdownMenu.Root>
						<DropdownMenu.Trigger asChild let:builder>
							<a class="block w-5 h-5" href="/" use:builder.action {...builder}>
								<Lucide icon="EllipsisVertical" class="w-5 h-5 text-slate-500" />
							</a>
						</DropdownMenu.Trigger>
						<DropdownMenu.Content class="w-56">
							<DropdownMenu.Label>Export Options</DropdownMenu.Label>
							...
							<DropdownMenu.Item>
								...
								Indonesia
								<div class="px-1 ml-auto text-xs text-white rounded-full bg-danger">10</div>
							</DropdownMenu.Item>
							<DropdownMenu.Item>
								<Lucide icon="LayoutDashboard" class="w-4 h-4 mr-2" />
								English
							</DropdownMenu.Item>
							<DropdownMenu.Item>
							...
							<DropdownMenu.Separator />
							<DropdownMenu.Label>
								<Button variant="primary" type="button" class="px-2 py-1">Settings</Button>
								<Button variant="secondary" type="button" class="px-2 py-1 ml-auto">
									View Profile
								</Button>
							</DropdownMenu.Label>
				...
				<div class="flex p-5 border-t border-slate-200/60 dark:border-darkmode-400">
					<Button variant="primary" type="button" class="px-2 py-1">New Group</Button>
				...
				<div class="p-5">
					<div class="flex flex-col xl:flex-row">
						<div class="flex-1 mt-6 xl:mt-0">
							<div class="grid grid-cols-12 gap-x-5">
								<div class="col-span-12 2xl:col-span-6">
									...
									<div class="mt-3">
										...
										<TomSelect id="update-profile-form-2" bind:value={select} class="w-full">
								...
								<div class="col-span-12 2xl:col-span-6">
									<div class="mt-3 2xl:mt-0">
										...
										<TomSelect id="update-profile-form-3" bind:value={select} class="w-full">
							...
							<Button variant="primary" type="button" class="w-20 mt-3">Save</Button>
						</div>
						<div class="mx-auto w-52 xl:mr-0 xl:ml-6">
							...
							>
								...
								<div class="relative mx-auto mt-5 cursor-pointer">
									<Button variant="primary" type="button" class="w-full">Change Photo</Button>
			...
			<div class="mt-5 intro-y box">
				...
				<div class="p-5">
					<div class="grid grid-cols-12 gap-x-5">
						...
						<div class="col-span-12 xl:col-span-6">
							...
							<div class="mt-3">
								...
								<TomSelect id="update-profile-form-12" bind:value={select} class="w-full">
					...
					<div class="flex justify-end mt-4">
						<Button variant="primary" type="button" class="w-20 mr-auto">Save</Button>
