<script lang="ts">
	...
	import { FormInput, FormCheck } from '$lib/components/Form';
				...
				<div class="flex h-screen py-5 my-10 xl:h-auto xl:py-0 xl:my-0">
					...
					>
						...
						>
							...
							<a class="text-primary dark:text-slate-200" href="#top"> Terms and Conditions </a>
							&
							<a class="text-primary dark:text-slate-200" href="#top"> Privacy Policy </a>
						</div>
					</div>
				</div>
				<!-- END: Login Form -->
